...
In order to build a type checker for a language, the user must have
...
they exist in the universe. In a single universe system there is nowhere else
...
listed together one after another, in order to give the
...
level term variable in scope. This premise states the condition that
